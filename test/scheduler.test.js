...
describe('get input and get output', () => {
    test('Meeting should not be scheduled outside of an office hours.', () => {
    ...
    test('Meeting should not be overlap with already scheduled meeting slot.', () => {
    ...
    test('All the booking requests should be proccessed in a chronological order.', () => {
